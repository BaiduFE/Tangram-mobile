...
test("正确url和正确data", function() {
	...
	var xhr = baidu.mobile.ajax.post(urlstring, arg);
	var check = function() {
...
test("onsuccess", function() {
	...
	var xhr = baidu.mobile.ajax.post(urlstring, arg, successAction);
});
...
test("输入不存在url以及设定onsuccess事件", function() {
	...
	var arg = "var1=baidu&var2=tangram";
	var xhr = baidu.mobile.ajax.post(urlstring, arg, function() {
