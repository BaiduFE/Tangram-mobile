 ...
 * 
 * path: baidu/mobile/dom/fixed.js
 * author: bang
 * version: 1.0.0
 * date: 2010/12/6
 */
...
///import baidu.mobile.event._customEvent.customScroll;
///import baidu.mobile.event.on;
///import baidu.mobile.browser.android;
 ...
 */
baidu.mobile.dom.fixed = function(elem, options) {
    elem = baidu.g(elem);
    options = options || {};
