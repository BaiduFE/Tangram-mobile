 ...
 * 
 * path: baidu.mobile/fx/stop.js
 * author: bang
 * version: 1.0.0
 * date: 2010/12/6
 */

///import baidu.mobile.fx;
///import baidu.dom.g;
 ...
 */
baidu.mobile.fx.stop = function(elem, gotoEnd) {
     var 
    ...
    for (var i = 0; i < props.length; i++) {
        ...
        styles[prop] = baidu.mobile.getStyle(elem, prop, !gotoEnd);
    }
    ...
    if (baidu.mobile.fx._clearQueue) {
        baidu.mobile.fx._clearQueue(elem);
    }
