...
/**
 * 将一个表单用ajax方式提交
 * @name baidu.mobile.ajax.form
 * @function
 * @grammar baidu.mobile.ajax.form(form[, options])
 ...
 * @see baidu.mobile.ajax.request
 *             
 * @returns {XMLHttpRequest} 发送请求的XMLHttpRequest对象
 */
baidu.mobile.ajax.form = function (form, options) {
    options = options || {};
    ...
    // 发送请求
    return baidu.mobile.ajax.request(url, sendOptions);
};
