...
///import baidu.mobile.ui.scroller.create;
 ...
 */        
baidu.mobile.ui.scroller.Scroller = function(elem, options) {
    var me = this;
    ...
    if (!baidu.mobile.browser.isSupportTouch && 
    ...
    baidu.mobile.setStyles(elem, {
        webkitTransitionProperty : '-webkit-transform',
        webkitTransitionTimingFunction : 'cubic-bezier(0,0,0.25,1)',
        webkitTransitionDuration : '0',
        webkitTransform : baidu.mobile.browser.getTranslate(0,0)
    });
    
    baidu.mobile.setStyle(me.wrapper, "overflow", "hidden");
    me.init();
    
    return me;
};

baidu.mobile.ui.scroller.Scroller.prototype = {
    x : 0,
    y : 0,
    ...
    init : function() {
        ...
        if (baidu.mobile.ui.scroller.createBar && me.options.scrollbar) {
            baidu.mobile.ui.scroller.createBar(me);
        }
        me.refresh();
    },
    ...
    touchEnd : function(e) {
        ...
        //动力加速
        if (baidu.mobile.ui.scroller._getMomentum && me.options.momentum) {
            var o = baidu.mobile.ui.scroller._getMomentum(me, deltaTime);
            newX = o.x;
            newY = o.y;
            duration = o.duration;
        }
    ...
    setTransitionTime: function(time) {
        baidu.mobile.setStyle(this.elem, "webkitTransitionDuration", time || '0');
    },
    ...
    setPosition : function(x, y) {
        ...
        me.x = x;
        me.y = y;
        baidu.mobile.setStyle(me.elem, "webkitTransform", baidu.mobile.browser.getTranslate(me.x, me.y));
    },
