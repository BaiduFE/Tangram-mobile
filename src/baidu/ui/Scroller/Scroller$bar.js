 ...
 * 
 * path: baidu/ui/Scroller/Scroller$bar.js
 * author: bang
 * version: 1.0.0
 * date: 2010/12/6
 */
 ...
 * @private
 */
baidu.ui.Scroller.createBar = function(scroller) {
    ...
    var  inject = {
        ...
        setTransitionTime: function(time) {
            ...
            scroller.scrollBarX &&
                baidu.setStyle(scroller.scrollBarX.bar, "webkitTransitionDuration", time);
            scroller.scrollBarY &&
                baidu.setStyle(scroller.scrollBarY.bar, "webkitTransitionDuration", time);
        },
...
baidu.ui.Scroller.Bar = function(dir, wrapper, fade, shrink, color) {
    var me = this,
        doc = document;
    ...
    me.bar.style.cssText = 'position:absolute;top:0;left:0;-webkit-transition-timing-function:cubic-bezier(0,0,0.25,1);pointer-events:none;-webkit-transition-duration:0;-webkit-transition-delay:0;-webkit-transition-property:-webkit-transform;z-index:10;background:' + color + ';' +
        '-webkit-transform:' + baidu.browser.getTranslate(0,0) + ';' +
...
baidu.ui.Scroller.Bar.prototype = {
    ...
    setPosition: function (pos) {
        ...
        pos = me.isHori ? 
            baidu.browser.getTranslate(pos, 0):
            baidu.browser.getTranslate(0, pos);
