 ...
 * 
 * path: baidu/ui/Scroller/Scroller$momentum.js
 * author: bang
 * version: 1.0.0
 * date: 2010/12/6
 */
 ...
 * @private
 */
baidu.ui.Scroller._getMomentum = function(scroller, deltaTime) {
    ...
    var momentumX = scroller.lockScrollX ? 
        { dist: 0, duration: 0 } :
        baidu.ui.Scroller._calcMomentum(scroller.x - scroller.startX,
                        deltaTime,
        ...
        momentumY = scroller.lockScrollY ? 
            { dist: 0, duration: 0 } : 
            baidu.uiScroller._calcMomentum(scroller.y - scroller.startY,
                            deltaTime,
